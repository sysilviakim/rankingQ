...
`identity` dataset. The package is designed for estimating various ranking-based quantities from ranking data. It also allows researchers to correct for measurement error caused by inattentive survey respondents.
